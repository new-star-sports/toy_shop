  ...
  return (
    <div className="max-w-4xl mx-auto py-12 px-4 sm:px-6 lg:px-8 space-y-8">
      <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
        ...
        <Button asChild className="bg-primary hover:bg-primary/90 gap-2 h-11 px-6 text-base">
      ...
      {addresses.length === 0 ? (
        <div className="text-center py-20 bg-muted rounded-3xl border-2 border-dashed border-border/50">
